...
//      the ready flag or the flush flag straight off it. All four faulted
//      before their guards went in, which is how a failed connection setup
//      surfaced as a SIGSEGV inside librccl instead of as a test failure.
//
