...
bool Device::create() {
  ...
  //Launch descriptor format 4 fw supported version.
  static constexpr uint32_t kMinUcodeForFormat4 = 352;
  ...
  hsaSettings->format4_supported_ =
      (ucodeStatus == HSA_STATUS_SUCCESS) && (ucodeVersion >= kMinUcodeForFormat4);

  ClPrint(amd::LOG_INFO, amd::LOG_INIT,
          "Format4 check: ucodeStatus=%d, ucodeVersion=%u, kMinUcodeForFormat4=%u, format4_supported=%d",
          ucodeStatus, ucodeVersion, kMinUcodeForFormat4, hsaSettings->format4_supported_);
